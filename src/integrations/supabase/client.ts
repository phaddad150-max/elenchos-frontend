...
const FALLBACK_SUPABASE_URL = "https://jacbalsongvqvaqlfsbx.supabase.co";
...
function createSupabaseClient() {
  ...
  if (
    ...
    console.warn("[Supabase] Using built-in jacbalsongvqvaqlfsbx credentials (set VITE_SUPABASE_* in Vercel).");
  }
