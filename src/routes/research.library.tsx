...
const TRACKERS = [
  ...
  },
  {
    ...
    body: "Public trust in AI / tech economy figures — builders and CEOs in citizen talk.",
    icon: Layers,
    badge: "Preview",
    accent: "amber" as const,
    metric: "15 figures",
  },
  {
    ...
    body: "Social-awareness voices — migration, accountability, free speech, conflict.",
    icon: Radio,
    badge: "Preview",
